...
import com.bluebuddy.adapters.MyEventAdapterimingone;
...
public class EventFragmentimingone extends Fragment  {

    private EmptyRecyclerView menu_recycler_view;
    private MyEventAdapterimingone myEventAdapter;
   ...
   // private LinearLayout create_event;
    ...
    public static EventFragmentimingone createInstance(int itemsCount) {
        EventFragmentimingone eventFragment = new EventFragmentimingone();
        Bundle bundle = new Bundle();
        eventFragment.setArguments(bundle);
        return eventFragment;
    }

    public static EventFragmentimingone createInstance(ArrayList<TripDetail> tripDetail) {
        EventFragmentimingone eventFragment = new EventFragmentimingone();
        Bundle bundle = new Bundle();
    ...
    public static EventFragmentimingone createInstance(ArrayList<MyTripDetails> myTripDetail, int i) {
        EventFragmentimingone eventFragment = new EventFragmentimingone();
        Bundle bundle = new Bundle();
    ...
    public static EventFragmentimingone createInstance(ArrayList<TripDetail> tripDetail, boolean _editAble) {
        EventFragmentimingone eventFragment = new EventFragmentimingone();
        Bundle bundle = new Bundle();
        bundle.putSerializable("tripDetail", tripDetail);
    ...
    public static EventFragmentimingone createInstance(ArrayList<TripDetail> tripDetail, boolean _editAble, boolean a) {
        EventFragmentimingone eventFragment = new EventFragmentimingone();
        Bundle bundle = new Bundle();
        bundle.putSerializable("tripDetail", tripDetail);
        /*bundle.putBoolean("_editAble", _editAble);*/
       ...
       // LinearLayout create_event=(LinearLayout)rootView.findViewById(R.id.create_event);
        ...
        if(bundle != null) {
            ...
            if(bundle.containsKey("tripDetail")){
                ...
                if(bundle.containsKey("_editAble")){
                    myEventAdapter = new MyEventAdapterimingone(activity, context, tripDetail, false);
                }else{
                    myEventAdapter = new MyEventAdapterimingone(activity, context, tripDetail);
                }
            }
            else if(bundle.containsKey("_editAble1")){
                myEventAdapter = new MyEventAdapterimingone(activity, context, tripDetail,true);
            ...
            myEventAdapter = new MyEventAdapterimingone(activity, context, null);
        ...
        bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(EventFragmentimingone.super.getContext(), CreateEventActivity3.class);
