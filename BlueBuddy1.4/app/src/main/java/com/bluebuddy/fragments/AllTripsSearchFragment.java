...
public class AllTripsSearchFragment extends Fragment {
...
//
public static AllTripsSearchFragment createInstance(int i) {
    AllTripsSearchFragment allTripsSearchFragment = new AllTripsSearchFragment();
    Bundle bundle = new Bundle();
    allTripsSearchFragment.setArguments(bundle);
    return allTripsSearchFragment;
}

    public static AllTripsSearchFragment createInstance(String category) {
        AllTripsSearchFragment allTripsSearchFragment = new AllTripsSearchFragment();
        Bundle bundle = new Bundle();
    ...
    public static AllTripsSearchFragment createInstance(String category, String token,String curru) {
        AllTripsSearchFragment allTripsSearchFragment = new AllTripsSearchFragment();
        Bundle bundle = new Bundle();
    ...
    public static AllTripsSearchFragment createInstance(String token,String cat,ArrayList<EventDetails> loc_srch) {
        AllTripsSearchFragment allTripsSearchFragment = new AllTripsSearchFragment();
        Bundle bundle = new Bundle();
        ...
        userCall.enqueue(new Callback<AllTrip>() {
            ...
            public void onFailure(Call<AllTrip> call, Throwable t) {
               // if (mProgressDialog.isShowing())
                ...
                Toast.makeText(getContext(),getContext().getText(R.string.goeswrong),Toast.LENGTH_SHORT).show();
