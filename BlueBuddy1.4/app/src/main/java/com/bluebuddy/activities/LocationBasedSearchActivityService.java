...
public class LocationBasedSearchActivityService extends BuddyActivity implements LocationListener {
    ...
    private String token, id, rds, s, bellcounter, curru;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        super.setLayout(R.layout.activity_people_search_clocation_service);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(LocationBasedSearchActivityService.this, BlueMarketServiceActivityNew.class);
                startActivity(i);
            }
        });
    ...
    private void fetchcurrentcharter() {
        ...
        Call<AllService> userCall = service.allservice1("Bearer " + token, _lat1, _long1, rds);
        ...
        userCall.enqueue(new Callback<AllService>() {
            ...
            public void onResponse(Call<AllService> call, Response<AllService> response) {
                ...
                if (details == null) {
                    oDialog("No Services Found", "Close", "", false, _activity, "", 0);
