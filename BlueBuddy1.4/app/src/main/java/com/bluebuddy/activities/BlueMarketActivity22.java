...
public class BlueMarketActivity22 extends BuddyActivity {
    ...
    private String token, contains_key, curru, bellcounter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _activity = this;
        _context = this;
        int permission = ContextCompat.checkSelfPermission(BlueMarketActivity22.this, Manifest.permission.ACCESS_FINE_LOCATION);
        if (permission != PackageManager.PERMISSION_GRANTED) {
            Log.i("HELLO", "Permission to location denied");

            if (ActivityCompat.shouldShowRequestPermissionRationale(BlueMarketActivity22.this, Manifest.permission.ACCESS_FINE_LOCATION)) {
                AlertDialog.Builder builder = new AlertDialog.Builder(BlueMarketActivity22.this);
                ...
                builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        Log.i("HELLO", "Clicked");
                        ActivityCompat.requestPermissions(BlueMarketActivity22.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.CAMERA, Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.WRITE_EXTERNAL_STORAGE}, RECORD_REQUEST_CODE);
                    }
                });
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(BlueMarketActivity22.this, Categories_bluemarketActivity2.class);
                startActivity(i);
            }
        });
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(BlueMarketActivity22.this, BlueMarketCharterPicActivity.class);
    ...
    public void getAllCharter() {
        ...
        Call<AllCharter> userCall = service.myCharter("Bearer " + token);
