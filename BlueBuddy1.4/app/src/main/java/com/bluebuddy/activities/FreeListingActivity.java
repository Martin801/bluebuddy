...
public class FreeListingActivity extends BuddyActivity {
    ...
    String[] BMCloc = {"London Docklands", "London Docklands", "India", "London Docklands", "London Docklands", "India"};
    String[] BMCposted = {"Martin jones", "Steve Jobes", "Ravindra", "Martin jones", "Steve Jobes", "Ravindra"};
   ...
   /* int[] BMCpic = {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        super.setLayout(R.layout.activity_free_listing);
        super.onCreate(savedInstanceState);
        // setContentView(R.layout.activity_free_listing);
        super.initialize();
        super.setTitle("FREE LISTING");
        _activity = this;
        _context = this;
