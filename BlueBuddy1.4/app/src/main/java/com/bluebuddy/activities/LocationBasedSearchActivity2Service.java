...
public class LocationBasedSearchActivity2Service extends BuddyActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    private String token, TAG, id, rds, s, _lat, _long, bellcounter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        super.setLayout(R.layout.activity_people_search_olocation2_service);
        ...
        serviceOfferedAdapter = new ServiceOfferedAdapter(_activity, _context, null, token, curru);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(LocationBasedSearchActivity2Service.this, BlueMarketServiceActivityNew.class);
                startActivity(i);
            }
        });
    ...
    private void currentlocationpeople() {
        ...
        if (location.isEmpty()) {
            ...
            Call<AllService> userCall = service.allservice11("Bearer " + token, _lat1, _long1, 50);
            userCall.enqueue(new Callback<AllService>() {
                @Override
                public void onResponse(Call<AllService> call, Response<AllService> response) {

                    ArrayList<AllServiceDetails> details = response.body().getService_list();

                    if (details != null) {
                        serviceOfferedAdapter.updateAllService(response.body().getService_list());
                    }
                    if (details == null) {
                        oDialog("No Services Found for this Location", "Close", "", false, _activity, "", 0);
                    }
