...
public class SingleChatActivity extends BuddyActivity implements View.OnClickListener {
    ...
    private MyTextView nvxtxt,bell_counter;
    private ImageView back,pro_pic;
    private String token, uid,bellcounter,id,firebase_id,firebase_email,charter_pro_pic,charter_name,AllCharter_FirebaseApi;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // Toast.makeText(ChatActivity.this,uid,Toast.LENGTH_LONG).show();
        ...
        id=b.getString("AllCharter");
        firebase_id=b.getString("AllCharter_Firebaseid");
        firebase_email=b.getString("AllCharter_FirebaseEmail");
        charter_pro_pic=b.getString("charter_pro_pic");
        charter_name=b.getString("charter_name");
        AllCharter_FirebaseApi=b.getString("AllCharter_FirebaseApi");
        final int pass=b.getInt("pass");
        pro_pic=(ImageView)findViewById(R.id.pro_pic);
        bell_counter=(MyTextView)findViewById(R.id.bell_counter);
        Glide.with(SingleChatActivity.this).asBitmap().load(IMG_URL + charter_pro_pic).into(new BitmapImageViewTarget(pro_pic) {
            @Override
            protected void setResource(Bitmap resource) {
                RoundedBitmapDrawable circularBitmapDrawable =
                        RoundedBitmapDrawableFactory.create(SingleChatActivity.this.getResources(), resource);
                circularBitmapDrawable.setCircular(true);
                pro_pic.setImageDrawable(circularBitmapDrawable);
            }
        });
       // Toast.makeText(SingleChatActivity.this,charter_pro_pic,Toast.LENGTH_LONG).show();
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        back = (ImageView) findViewById(R.id.imgNotification2);
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(SingleChatActivity.this, Blue_Charter_Details.class);
                i.putExtra("AllCharter",id);
                i.putExtra("AllCharter_Firebaseid",firebase_id);
                i.putExtra("AllCharter_FirebaseEmail",firebase_email);
                i.putExtra("charter_pro_pic",charter_pro_pic);
                i.putExtra("charter_name",charter_name);
                i.putExtra("AllCharter_FirebaseApi",AllCharter_FirebaseApi);
        ...
        if (view.getId() == R.id.btnSend) {
            ...
            if (content.length() > 0) {
             ...
             //   notification.put("title", String.valueOf(R.string.app_name));
                ...
                sendNotification(serverkey, new PushRequest(AllCharter_FirebaseApi, notification));
            }
        }
    }
        ...
        public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
            if (holder instanceof ItemMessageFriendHolder) {
             ...
             //   Bitmap currentAvata = bitmapAvata.get(conversation.getListMessageData().get(position).idSender);
               if (charter_pro_pic != null) {
                   Glide.with(SingleChatActivity.this).asBitmap().load(IMG_URL + charter_pro_pic).into(new BitmapImageViewTarget(((ItemMessageFriendHolder) holder).avata) {
                       @Override
                       protected void setResource(Bitmap resource) {
                           RoundedBitmapDrawable circularBitmapDrawable =
                                   RoundedBitmapDrawableFactory.create(SingleChatActivity.this.getResources(), resource);
                        ...
                        public void onResponse(Call<AfterLoginStatus> call, Response<AfterLoginStatus> response) {
                            ...
                            if (response.body().getStatus() == true) {
                                ...
                                if (p != null) {
                                    ...
                                    Glide.with(SingleChatActivity.this).asBitmap().load(IMG_URL + profile_Pic).into(new BitmapImageViewTarget(((ItemMessageUserHolder) holder).avata) {
                                        @Override
                                        protected void setResource(Bitmap resource) {
                                            RoundedBitmapDrawable circularBitmapDrawable =
                                                    RoundedBitmapDrawableFactory.create(SingleChatActivity.this.getResources(), resource);
