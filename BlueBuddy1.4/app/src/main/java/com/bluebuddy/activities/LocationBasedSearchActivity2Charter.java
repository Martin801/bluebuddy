...
public class LocationBasedSearchActivity2Charter extends BuddyActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        super.setLayout(R.layout.activity_people_search_olocation2_charter);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(LocationBasedSearchActivity2Charter.this, BlueMarketCharterActivityNew.class);
                startActivity(i);
            }
        });
    ...
    private void currentlocationpeople() {
        ...
        if (location.isEmpty()) {
            ...
            Call<AllCharter> userCall = service.allcharter11("Bearer " + token, _lat1, _long1, 50);
            userCall.enqueue(new Callback<AllCharter>() {
                ...
                public void onResponse(Call<AllCharter> call, Response<AllCharter> response) {
                    ...
                    if (details == null) {
                        oDialog("No Charter Found for this Location", "Close", "", false, _activity, "", 0);
                    }
