...
public class LocationBasedSearchActivityProduct extends BuddyActivity implements LocationListener {
    ...
    private String token, id, rds, s, category, bellcounter, curru;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        super.setLayout(R.layout.activity_people_search_clocation_product);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(LocationBasedSearchActivityProduct.this, BlueMarketProductActivityNew.class);
    ...
    private void fetchcurrentcharter() {
        ...
        Call<AllProduct> userCall = service.allproduct1("Bearer " + token, _lat1, _long1, rds, category);
        ...
        userCall.enqueue(new Callback<AllProduct>() {
            ...
            public void onResponse(Call<AllProduct> call, Response<AllProduct> response) {
                ...
                if (details == null) {
                    oDialog("No Products Found", "Close", "", false, _activity, "", 0);
