...
import static com.bluebuddy.Utilities.Utility.RECORD_REQUEST_CODE;
...
public class BlueMarketCourseActivityNew extends BuddyActivity implements LocationListener, GoogleApiClient.OnConnectionFailedListener {
    ...
    List<AllCourseDetails> allCourseDetailsList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pagerAdapter.addFragment(AllCourseListFragment.createInstance(category, token, curru), "Courses");
        pagerAdapter.addFragment(LocationSearchFragmentCourse.createInstance(category, token), "Location");
    ...
    void initialize_all() {
       ...
       /* frm_date = (Button) findViewById(R.id.frm_date);
        ...
        allCourseDetailsList = new ArrayList<AllCourseDetails>();
        blueMarketCoursesAdapter = new BlueMarketCoursesAdapter(_activity, _context, allCourseDetailsList, token, category, curru);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // Click action
                Intent intent = new Intent(_activity, BlueMarketCoursePicActivity.class);
...
//        checkBeforeServiceCall();
    ...
    private void currentlocationsearch() {
        ...
        int permission = ContextCompat.checkSelfPermission(_activity, Manifest.permission.ACCESS_FINE_LOCATION);
        if (permission != PackageManager.PERMISSION_GRANTED) {
            if (ActivityCompat.shouldShowRequestPermissionRationale(_activity, Manifest.permission.ACCESS_FINE_LOCATION)) {
                ...
                builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ActivityCompat.requestPermissions(_activity, new String[]{Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.CAMERA, Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.WRITE_EXTERNAL_STORAGE}, RECORD_REQUEST_CODE);
            ...
            if (current_location_lat == null || current_location_long == null) {
...
//        Intent i = new Intent(BlueMarketCourseActivityNew.this, ActivityFilterCourses.class);
//        startActivity(i);
        finish();
    }
    ...
    public void serverCall(String sendCategory, String user_lat, String user_long, String radius_send) {
        if (isActivityVisible()) {
            ...
            Call<AllCourse> userCall = service.allCourseSearch("Bearer " + token, sendCategory, user_lat, user_long, radius_send);
            userCall.enqueue(new Callback<AllCourse>() {
                ...
                public void onResponse(Call<AllCourse> call, Response<AllCourse> response) {
                    ...
                    if (response.code() == AppConfig.SUCCESS_STATUS) {
                        if (response.body().getStatus() == true && response.body().getCourse_list().size() > 0) {
                            tv_noDataFound.setVisibility(View.GONE);
                            recyclerView.setVisibility(View.VISIBLE);
                            allCourseDetailsList.clear();
                            allCourseDetailsList.addAll(response.body().getCourse_list());
