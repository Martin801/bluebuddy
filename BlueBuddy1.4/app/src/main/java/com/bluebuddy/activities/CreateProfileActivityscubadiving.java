...
public class CreateProfileActivityscubadiving extends BuddyActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        super.setLayout(R.layout.activity_create_profile3_scubadiving);
...
//
//                Intent i = new Intent(CreateProfileActivityscubadiving.this, RUCActivity.class);
//                startActivity(i);
        ...
        skp.setOnClickListener(v -> {
            ...
            Intent i = new Intent(CreateProfileActivityscubadiving.this, CreateProfileActivity4.class);
            startActivity(i);
    ...
    public void cp3nxt() {
        ...
        if (crtname.isEmpty()) {
            ...
            Call<ServerResponseCp3> userCall = service.Cp3("Bearer " + token, "4", crtname, crtlevel, numcrt, "Scuba_Diving");
                ...
                public void onResponse(Call<ServerResponseCp3> call, Response<ServerResponseCp3> response) {
                    ...
                    if (response.body().getStatus() == "true") {
                        ...
                        if (both) {
                            ...
                            Intent intent = new Intent(CreateProfileActivityscubadiving.this, CreateProfileActivityfreediving.class);

                            startActivity(intent);
//                            finish();
                        } else if (!both) {
                            Intent intent = new Intent(CreateProfileActivityscubadiving.this, CreateProfileActivity4.class);
...
//                            finish();
                        ...
                        Log.d("onResponse", "" + response.body().getStatus());
                        logoutAndSignInPage(CreateProfileActivityscubadiving.this);
                    }
                }
    ...
    public void cp3skp(View view) {
        setMyPref(ACCESS_STEP, "4");
        Intent jj = new Intent(CreateProfileActivityscubadiving.this, CreateProfileActivity4.class);
        startActivity(jj);
    }
