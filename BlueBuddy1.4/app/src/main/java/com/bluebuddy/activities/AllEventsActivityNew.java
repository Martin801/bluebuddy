...
public class AllEventsActivityNew extends BuddyActivity implements LocationListener, GoogleApiClient.OnConnectionFailedListener {
    ...
    private String token, id, category, fromDate, toDate, curru, bellcounter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (b != null) {
           /* if(b.containsKey("loc_srch") && b.containsKey("interestList")){
                ...
                pagerAdapter.addFragment(AllTripsSearchFragment.createInstance(token,"",loc_srch), "Trips");
       ...
       /* ViewPager viewPager = (ViewPager) findViewById(R.id.viewPager);
        TabsPagerAdapter pagerAdapter = new TabsPagerAdapter(getSupportFragmentManager());
        pagerAdapter.addFragment(AllTripsSearchFragment.createInstance(category, token, curru), "Trips");
        pagerAdapter.addFragment(LocationSearchFragment.createInstance(category, token), "Location");
        viewPager.setAdapter(pagerAdapter);
        TabLayout tabLayout = (TabLayout) findViewById(R.id.tabLayout);
        tabLayout.setupWithViewPager(viewPager);*/
...
//                startActivity(i);
    ...
    void permissionCheckforGps() {
        ...
        int permission = ContextCompat.checkSelfPermission(AllEventsActivityNew.this, Manifest.permission.ACCESS_FINE_LOCATION);

        if (permission != PackageManager.PERMISSION_GRANTED) {
            // Log.i("HELLO", "Permission to location denied");
            isCurrentLocationGranted = false;
            if (ActivityCompat.shouldShowRequestPermissionRationale(AllEventsActivityNew.this, Manifest.permission.ACCESS_FINE_LOCATION)) {
                AlertDialog.Builder builder = new AlertDialog.Builder(AllEventsActivityNew.this);
                ...
                builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ActivityCompat.requestPermissions(AllEventsActivityNew.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.CAMERA, Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.WRITE_EXTERNAL_STORAGE}, RECORD_REQUEST_CODE);
    ...
    void initialize_all() {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // Click action
                Intent intent = new Intent(_activity, CreateEventActivity3.class);
                intent.putExtra("pass", 1);
                intent.putExtra("interestList", category);
    ...
    void clickListnerInitiliseAll() {
        ...
        frm_date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(_activity, date, myCalendar
        ...
        to_date.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(_activity, date1, myCalendar
                        .get(Calendar.YEAR), myCalendar.get(Calendar.MONTH),
                        myCalendar.get(Calendar.DAY_OF_MONTH));
                datePickerDialog.getDatePicker().setMinDate(System.currentTimeMillis() - 1000);
                datePickerDialog.show();
...
//                serverCall("", current_location_lat, current_location_long, radious);
                ...
                serverCall(category, current_location_lat, current_location_long, radious);
            } else {
                // oDialog("Current Location Not Found.", "Close", "", "", "", false, _activity,"",0);
                // oDialog("Your GPS is off. Please on GPS.", "Close", "", false, _activity, "", 0);
...
//                serverCall("", _lat, _long, Utility.DEFAULT_RADIOUS);
                // modified on 09-04-18
                serverCall(category, _lat, _long, Utility.DEFAULT_RADIOUS);
//                serverCall(category, _lat, _long, "");
            }
        }
    }
            ...
            userCall.enqueue(new Callback<AllTrip>() {
                ...
                public void onResponse(Call<AllTrip> call, Response<AllTrip> response) {
                    ...
                    if (response.code() == AppConfig.SUCCESS_STATUS) {
                        ...
                        if (response.body().getStatus() == true && response.body().getDetails().size() > 0) {
                            tv_noDataFound.setVisibility(View.GONE);
                            recyclerView.setVisibility(View.VISIBLE);
                            eventDetailsList.clear();
                            eventDetailsList.addAll(response.body().getDetails());
