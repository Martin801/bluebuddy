...
public class CreateProfileActivityscubadiving2 extends BuddyActivity {
    ...
    private void initializeElements() {
        ...
        skp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(CreateProfileActivityscubadiving2.this, MyCertificationActivity.class);
                startActivity(i);
            }
        });
    ...
    public void cp3nxt() {
        ...
        if (crtname.isEmpty()) {
            ...
            Call<ServerResponseCp3> userCall = service.Cp3("Bearer " + token, "", crtname, crtlevel, numcrt, "Scuba_Diving");
    ...
    public void cp3skp(View view) {
        Intent jj = new Intent(CreateProfileActivityscubadiving2.this, MyCertificationActivity.class);
        startActivity(jj);
    }
