...
public class LocationBasedSearchActivityCourse extends BuddyActivity implements LocationListener {
    ...
    private String token, id, rds, s, category, bellcounter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        super.setLayout(R.layout.activity_people_search_clocation_course);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(LocationBasedSearchActivityCourse.this, BlueMarketCourseActivityNew.class);
    ...
    private void fetchcurrentcharter() {
        ...
        Call<AllCourse> userCall = service.allcourse1("Bearer " + token, _lat1, _long1, rds, category);
        ...
        userCall.enqueue(new Callback<AllCourse>() {
            ...
            public void onResponse(Call<AllCourse> call, Response<AllCourse> response) {
                ...
                if (details == null) {
                    oDialog("No Courses Found", "Close", "", false, _activity, "", 0);
