...
public class LocationBasedSearchActivity2Course extends BuddyActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    private String token, TAG, id, rds, s, _lat, _long, category, cat2, bellcounter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        super.setLayout(R.layout.activity_people_search_olocation2_course);
        ...
        category = b.getString("cat11");
        Log.d("hello2", category);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(LocationBasedSearchActivity2Course.this, BlueMarketCourseActivityNew.class);
    ...
    private void currentlocationpeople() {
        ...
        if (location.isEmpty()) {
            ...
            Call<AllCourse> userCall = service.allcourse11("Bearer " + token, _lat1, _long1, 50, category);
            userCall.enqueue(new Callback<AllCourse>() {
                @Override
                public void onResponse(Call<AllCourse> call, Response<AllCourse> response) {

                    ArrayList<AllCourseDetails> details = response.body().getCourse_list();

                    if (details != null) {
                        blueMarketCoursesAdapter.updateAllCourses(response.body().getCourse_list());
                    }
                    if (details == null) {
                        oDialog("No Courses Found for this Location", "Close", "", false, _activity, "", 0);
                    }
