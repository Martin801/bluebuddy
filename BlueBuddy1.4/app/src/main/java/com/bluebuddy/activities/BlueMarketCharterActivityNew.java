...
public class BlueMarketCharterActivityNew extends BuddyActivity implements LocationListener, GoogleApiClient.OnConnectionFailedListener {

    private static final String TAG = "BMarketCharterActNew";
    ...
    List<AllCharterDetails> allCharterList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        super.setTitle("BOAT RENTALS/CHARTER");
      ...
      /*  ViewPager viewPager = (ViewPager) findViewById(R.id.viewPager);
        ...
        pagerAdapter.addFragment(AllCharterListFragment.createInstance(category, token, curru), "Boats");
        pagerAdapter.addFragment(LocationSearchFragmentCharter.createInstance(category, token), "Location");
    ...
    void initialize_all() {
       ...
       /* frm_date = (Button) findViewById(R.id.frm_date);
        ...
        allCharterList = new ArrayList<AllCharterDetails>();
        blueCharterAdapter = new BlueCharterAdapter(_activity, _context, allCharterList, token, curru);
        //  allEventAdapter = new AllEventAdapter(_activity, _context, eventDetailsList, token,curru);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // Click action
                Intent intent = new Intent(_activity, BlueMarketCharterPicActivity.class);
    ...
    void hideShowLayOut() {
        if (showStatus == 1) {
            ...
            //Check data before service call
            checkBeforeServiceCall();
...
//        checkBeforeServiceCall();
    ...
    private void currentlocationsearch() {
        int permission = ContextCompat.checkSelfPermission(BlueMarketCharterActivityNew.this, Manifest.permission.ACCESS_FINE_LOCATION);
        if (permission != PackageManager.PERMISSION_GRANTED) {
            /* Log.i("HELLO", "Permission to location denied");*/

            if (ActivityCompat.shouldShowRequestPermissionRationale(BlueMarketCharterActivityNew.this, Manifest.permission.ACCESS_FINE_LOCATION)) {
                AlertDialog.Builder builder = new AlertDialog.Builder(BlueMarketCharterActivityNew.this);
                ...
                builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        ActivityCompat.requestPermissions(BlueMarketCharterActivityNew.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.CAMERA, Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.WRITE_EXTERNAL_STORAGE}, RECORD_REQUEST_CODE);
...
//        Intent i = new Intent(BlueMarketCharterActivityNew.this, Categories_bluemarketActivity.class);
//        startActivity(i);
        finish();
    }
    ...
    public void serverCall(String sendCategory, String user_lat, String user_long, String radius_send) {
        if (isActivityVisible()) {
            ...
            Call<AllCharter> userCall = service.allCharterSearch("Bearer " + token, user_lat, user_long, radius_send);
            ...
            userCall.enqueue(new Callback<AllCharter>() {
                ...
                public void onResponse(Call<AllCharter> call, Response<AllCharter> response) {
                    ...
                    if (response.code() == AppConfig.SUCCESS_STATUS) {
                        if (response.body().getStatus() == true && response.body().getCharter_list().size() > 0) {
                            tv_noDataFound.setVisibility(View.GONE);
                            recyclerView.setVisibility(View.VISIBLE);
                            allCharterList.clear();

                            Log.d(TAG, "onResponse: " + response.body().getCharter_list());

                            allCharterList.addAll(response.body().getCharter_list());
