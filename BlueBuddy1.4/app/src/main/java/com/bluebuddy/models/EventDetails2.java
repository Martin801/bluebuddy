...
public class EventDetails2 implements Serializable {
    ...
    public EventDetails2(String event_id, String user_id, String location, String event_date, String activity, String fragment, String description, String participants, String creator_fname, String creator_lname, String creator_dp, String creator_email, String creator_firebase_api_key, String creator_firebase_reg_id, String participated, String no_of_participant, String is_editable){
    ...
    public String toString(){
        return "event_id: " + event_id + ", is_editable: " + is_editable + ", location: " + is_editable + ", event_date: " + event_date + ", activity: " + activity + ", description: " + description + ", participants: " + participants + ", creator_fname: " + creator_fname + ", creator_lname: " + creator_lname;
    }
