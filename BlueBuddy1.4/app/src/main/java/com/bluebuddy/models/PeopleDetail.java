...
public class PeopleDetail  {
  ...
  //  private String certification_details ="";
   private ArrayList<Cert_user> certification_details = new ArrayList<Cert_user>();
//
  private String Token = "";
    ...
    public String toString() {
        return "Email: " + Email + ", First_name: " + First_name + ", Last_name: " + Last_name + ",  Phone: " + Phone + ", About: " + About + ",Social_link_type:" + Social_link_type + ", Social_link: " + Social_link + ",Website_link:" + Website_link + ", Profile_pic: " + Profile_pic + ", Interested_in: " + Interested_in + ",Location:" + Location + ",next_step:" + next_step + ", Location: " + Location + ", buddy_uid: " + buddy_uid
                ...
                "Firebase_API_key: " + Firebase_API_key + ", Firebase_reg_id: " + Firebase_reg_id + ", Certification_type: " + Certification_type;
    }
 ...
 public ArrayList<Cert_user> getCertification_details() {
        return certification_details;
    }

    public void setCertification_details(ArrayList<Cert_user> certification_details) {
   ...
   /* public List<Cert_user> getCertification_details() {
        return certification_details;
    }

    public void setCertification_details(List<Cert_user> certification_details) {
        this.certification_details = certification_details;
    }*/
}
