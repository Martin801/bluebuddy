...
public class MyEventAdapterimingone extends RecyclerView.Adapter<MyEventAdapterimingone.ViewHolder> {
    ...
    public MyEventAdapterimingone() {

    }

    public MyEventAdapterimingone(Activity a, Context c, ArrayList<TripDetail> EVENTList22, boolean _editAble) {
        this._activity = a;
        this._context = c;
    ...
    public MyEventAdapterimingone(Activity a, Context c, ArrayList<TripDetail> EVENTList22) {
        this._activity = a;
        this._context = c;
        this.EVENTList22 = EVENTList22;
    }
