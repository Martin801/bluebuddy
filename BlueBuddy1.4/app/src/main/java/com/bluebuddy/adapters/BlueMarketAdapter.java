...
import com.bluebuddy.activities.EventsDetailsActivity;
...
public class BlueMarketAdapter extends RecyclerView.Adapter<BlueMarketAdapter.ViewHolder> {
    ...
    public BlueMarketAdapter() {
    }


    public BlueMarketAdapter(Activity a, Context c, List<BlueMarketItems> BMCList) {
        this._activity = a;
//        this.blueMarketActivity = (BlueMarketActivity) a;
    ...
    @Override
    public BlueMarketAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(BlueMarketAdapter.ViewHolder holder, int position) {
