...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewHolders> {
    ...
    public RecyclerViewAdapter(Activity a, Context context, List<PeopleSearchGalleryItems> itemList) {
        this._activity = a;
    ...
    public void onBindViewHolder(RecyclerViewHolders holder, int position) {
        ...
        holder.CVPS.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(_activity, PeopleSearchActivity.class);
