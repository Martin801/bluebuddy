...
import com.bluebuddy.activities.ActivityAddYourServicesEdit;
import com.bluebuddy.activities.ServiceDetailsActivity;
import com.bluebuddy.activities.SingleChatActivity;
import com.bluebuddy.activities.SingleChatActivityservicechat;
...
public class ServiceOfferedAdapter2 extends RecyclerView.Adapter<ServiceOfferedAdapter2.ViewHolder> {
    ...
    public ServiceOfferedAdapter2() {
    }

    public ServiceOfferedAdapter2(Activity a, Context c, List<AllServiceDetails> BCCList, String token,String curru) {
        this._activity = a;
        this._context = c;
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public Button bmsmsg,bmsdet,contact_me,report_flag,bmcedt,chatBtn;
  ...
  //      public Button bccDt,chatBtn;
        ...
        public ViewHolder(View v) {
            ...
            bmsmsg=(Button)v.findViewById(R.id.bmsmsg);
    ...
    @Override
    public ServiceOfferedAdapter2.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final ServiceOfferedAdapter2.ViewHolder holder, final int position) {
     ...
     //   Log.d("rate:", allServiceDetails.getRating());
       ...
       // Glide.with(imageView.getContext()).load(allServiceDetails.getPicture()).asBitmap().into(new BitmapImageViewTarget(holder.bmspic));
       ...
       holder.bmsdet.setOnClickListener(new View.OnClickListener() {
        ...
        holder.bmsmsg.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        holder.bmcedt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(v.getContext(),ActivityAddYourServicesEdit.class);
