...
extension MICountryPicker {
    ...
    override open func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        didSelectCountryWithCallingCodeClosure?(country.name, country.code, country.dialCode, UIImage(named: "assets.bundle/" + country.code.lowercased() + ".png", in: Bundle(for: MICountryPicker.self), compatibleWith: nil)!)
    }
}
